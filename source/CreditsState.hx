...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['Nebulazorua andromeda-engine',		'shadowmario',		'highest combo  and  epic judgement \nyour engine is the best!',									'https://github.com/nebulazorua/andromeda-engine',							'9999FF'],
			['jloor engine',			'bb-panzu',			'cool title screen',													'https://github.com/JloorMC/Jloor-Engine-Main',								'389A58'],
			['Just Jack',				'bb-panzu',			'cool Cache screen',													'https://twitter.com/Just_Jack6',											'389A58'],
			...
			['Friday Night Voltex',		'bb-panzu',			'ms counter',															'https://gamebanana.com/mods/345560',										'389A58'],
